...
prod_server_start=yes #yes/no/standby
...
production_ip=172.19.0.4 #ip a. look for eth or eth0. pick the ip that has a subnet. eg 127.20.0.3/16
production_port=5433

replica_name=main
replica_var_path=/var/lib/postgresql/10/main
replica_etc_path=/etc/postgresql/10/main
replica_ip=172.19.0.3
replica_port=5433
