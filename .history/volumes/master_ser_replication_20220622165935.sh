...
"#host:port:database:user:password" >> /var/lib/postgresql/.pgpass
"$other_instance_ip:$other_instance_port:replication:rep_user:rep_user_123" >> /var/lib/postgresql/.pgpass
